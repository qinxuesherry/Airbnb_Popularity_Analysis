...
model_lrg.plot(confusion, y_prob, y_test,save_fig=True, filename='Images/Fine tuned model/logistic_regression_analysis.png')
...
## Plot the confusion matrix and ROC curve
model_svm.plot(confusion, y_prob, y_test, save_fig=True, filename='Images/Fine tuned model/support_vector_machine_analysis.png')
...
## Plot the confusion matrix and ROC curve
model_lda.plot(confusion, y_prob, y_test, save_fig=True, filename='Images/Fine tuned model/linear_discriminant_analysis.png')
...
## Plot the confusion matrix and ROC curve
model_qda.plot(confusion, y_prob, y_test, save_fig=True, filename='Images/Fine tuned model/quadratic_discriminant_analysis.png')
...
model_rfc.plot(confusion, y_prob_rfc, y_test, save_fig=True, filename='Images/Fine tuned model/random_forest_classifier.png')
...
model_tree.plot(confusion, y_prob_rfc, y_test, save_fig=True, filename='Images/Fine tuned model/decision_tree_classifier.png')
...
plot_model_comparison(save_fig=True, filename='Images/Fine tuned model/model_comparison.png')